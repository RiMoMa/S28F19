...
\only<2->{\vspace*{-3cm}
	\begin{alertblock}
{		\LARGE Some studies suggest that the cancer progression could not follow this sequence!\footnotemark[1]}
	\end{alertblock}
}
...
%  
%
%\begin{frame}{reasons to doubt}
%
%\begin{itemize}
% \item Diffuse type of gastric cancer are not related with atrophy or metaplasia (Lauren classification)
% \pause
% \item In the non-atrophic gastritis foci of intestinal metaplasia are found  \footnote{Stolte M, Zeitschrift f\"ur Gastroenterologie, 1992 \label{repite}}
%
% \pause
%  \item \normalsize Metaplasia grade I and II have been show no risk for cancer progression. \footnote{Filipe ML, International Journal of Cancer, 1994}
%  \item Dysplasia are not found in micro-early carcinomas ($Diameter < 5mm$)\footnote{Hattori T.,Cancer 1986}\footnote{•}
%  \footnote{Stolte M, Zeitschrift f\"ur Gastroenterologie, 1992}
%
%  
%\end{itemize}
%
