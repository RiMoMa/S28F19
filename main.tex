...
%\hspace*{-3cm}
\begin{itemize}
\item<1-> \smallsize Using a color deconvolution technique the Hematoxylin (H) and eosin (E) stains are estimated% \footnote{\tiny{A method for normalizing histology slides for quantitative analysis, Macenko et al.ISBI 2009}}
\item<3-> \smallsize Watershed algorithm is used to detect nuclei candidates in H stain%\footnote{\tiny{Veta M.,ISBI 2011}}
\item<4-> \smallsize Final candidates are found after morphological operations
\end{itemize}
